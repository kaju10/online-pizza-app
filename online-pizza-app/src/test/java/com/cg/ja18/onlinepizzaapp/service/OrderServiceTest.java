...
class OrderServiceTest {
	...
	void setUp() throws Exception {
		...
		order = Order.builder().orderId(1L).orderType("Online").orderDescription("Add oregano").customer(customer)
	...
	void viewOrderListTest() throws OrderIdNotFoundException {
	...
	void updateOrderTest() throws OrderIdNotFoundException {
